# 1 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c"
...
# 1 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
...
# 2 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
...
# 3 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
...
# 4 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
...
Action()
{
	...
	lr_end_transaction("SC05_JPETSTORE_TR01_CLICK ON ENTER THE STORE",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR02_CLICK ON SIGN IN",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR03_CLICK ON LOGIN",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR04_SELECT PRODUCT",2);
    ...
    lr_end_transaction("SC05_JPETSTORE_TR05_SELECT PRODUCT ID",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR06_CLICK ON ADD TO CART",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR07_CLICK ON PROCEED TO CHECKOUT",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR08_CLICK ON CONTINUE",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR09_CLICK ON CONFIRM",2);
...
fclose(File);
	...
	lr_end_transaction("SC05_JPETSTORE_TR10_CLICK ON RETRURN TO MAIN MENU",2);
	...
	lr_end_transaction("SC05_JPETSTORE_TR11_CLICK ON SIGN OUT",2);

	return 0;
}
# 5 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
...
# 6 "c:\\users\\10699367\\documents\\vugen\\scripts\\sc05_jpetstore\\\\combined_SC05_Jpetstore.c" 2
